...
🌆 Если вы хотите запустить краш-бота, кликайте по кнопке и следуйте дальнейшим инструкциям в комадной строке!

:paperclip: Если вы хотите запустить статус(DiscordRPC), кликайте по кнопке и также следуйте дальнейшим инструкциям в командной строке!
